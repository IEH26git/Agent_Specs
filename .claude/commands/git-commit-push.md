...
Stage all changes in the Agent_Specs repo (`/Users/ianheiman/_Agents/_All-Agents-admin/Agent_Specs`), generate a descriptive commit message from the diff, commit, and push.
